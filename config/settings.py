...
SPECTACULAR_SETTINGS = {
    "TITLE": "Homework30 LMS API",
    "DESCRIPTION": "API для курсов, уроков, пользователей, подписок и оплаты через Stripe.",
    "VERSION": "1.0.0",
...
# Настройки электронной почты для уведомлений от разработчиков и Celery.
